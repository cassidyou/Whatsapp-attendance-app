  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4" id="sidenav-main" >
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" ">
        ...
        <span class="ms-1 font-weight-bold">Blogger</span>
      </a>
    </div>
    <hr class="horizontal dark mt-0">
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main" style="height: 400px; overflow-y:scroll;">
      <ul class="navbar-nav h-100">
        ...
        <li class="nav-item">
          <a class="nav-link" href="create-group.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link" href="upload-chat.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa fa-upload text-primary text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Upload Chat</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link " href="groups.php">
            ...
            <span class="nav-link-text ms-1">Your Groups</span>
          </a>
        </li>
        <li class="nav-item">
